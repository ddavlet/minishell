...
PAR2_SRC_DIR := parsing_experimental/
PAR_SRC_DIR := parsing/
BUL_SRC_DIR := builtin/
...
IO_SOURCE := find_last_input_redir.c find_last_output_redir.c handle_append.c handle_here_document.c handle_input.c \
				handle_truncate.c
UTL_EXE_SOURCE := utils.c reverse_pars.c path.c cmd_check.c 
...
OBJ = $(EXE_SRCS:.c=.o) $(PAR_SRCS:.c=.o) $(PAR2_SRCS:.c=.o) $(BUL_SRCS:.c=.o) $(MAIN:.c=.o)
